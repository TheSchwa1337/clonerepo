...
import numpy as np
import pytest
from numpy.testing import assert_allclose, assert_array_almost_equal, assert_warns, suppress_warnings
from scipy.optimize import BFGS, LinearConstraint, NonlinearConstraint, OptimizeWarning, minimize
