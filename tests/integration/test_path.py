...
@pytest.mark.parametrize(
    ...
    [
        (
            Path([(0.25, 0.25), (0.25, 0.75), (0.75, 0.75), (0.75, 0.25), (0.25, 0.25)], closed=True),
            True,
            False,
        ),
        (
        ...
        (
            Path([(0.25, 0.25), (0.25, 1.25), (1.25, 1.25), (1.25, 0.25), (0.25, 0.25)], closed=True),
            False,
            False,
        ),
...
@pytest.mark.parametrize(
    'phi',
    np.concatenate([np.array([0, 15, 30, 45, 60, 75, 90, 105, 120, 135]) + delta for delta in [-1, 0, 1]]),
)
