...
class TestManyStencils(TestStencilBase):
    ...
    def test_basic38(self):
        ...
        a = np.arange(12.0).reshape(3, 4)
        ex = self.exception_dict(stencil=NumbaValueError, parfor=NumbaValueError, njit=NumbaValueError)
    ...
    def test_basic44(self):
        ...
        a = np.arange(12.0).reshape(3, 4)
        b = np.arange(12.0).reshape(3, 4)
        self.check_exceptions(kernel, a, b, expected_exception=[NumbaValueError, LoweringError])
    ...
    def test_basic53(self):
        ...
        a = np.arange(12.0).reshape(3, 4)
        b = np.arange(12.0).reshape(3, 4)
        ex = self.exception_dict(stencil=Exception, parfor=NumbaValueError, njit=Exception)
