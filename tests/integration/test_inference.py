...
from sympy.logic.boolalg import And, Equivalent, Implies, Or, false, true
from sympy.logic.inference import PropKB, entails, literal_symbol, pl_true, satisfiable, valid
