...
class TestFastMathOption(CUDATestCase):
    ...
    def test_cosf(self):
        self._test_fast_math_unary(
            cos,
            FastMathCriterion(fast_expected=['cos.approx.ftz.f32 '], prec_unexpected=['cos.approx.ftz.f32 ']),
        )

    def test_sinf(self):
        self._test_fast_math_unary(
            sin,
            FastMathCriterion(fast_expected=['sin.approx.ftz.f32 '], prec_unexpected=['sin.approx.ftz.f32 ']),
        )
    ...
    def test_tanhf(self):
        ...
        self._test_fast_math_unary(
            tanh,
            FastMathCriterion(fast_expected=['tanh.approx.f32 '], prec_unexpected=['tanh.approx.f32 ']),
        )
    ...
    def test_log2f(self):
        self._test_fast_math_unary(
            log2,
            FastMathCriterion(fast_expected=['lg2.approx.ftz.f32 '], prec_unexpected=['lg2.approx.ftz.f32 ']),
        )
