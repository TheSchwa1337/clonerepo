...
from numpy.testing import assert_, assert_array_equal, assert_equal, assert_raises, assert_raises_regex
...
class TestMethods:
    ...
    def test_replace_count_and_size(self):
        ...
        assert_array_equal(
            r5,
            np.array(['01234ABCDE6789' * i for i in range(3)] + ['01234ABCDE6789' + '0123456789' * 2]),
        )
