...
if (
np.any(high_volume_clusters)
and price_momentum > self.liquidity_threshold
):
direction = "pump"
...
oscillator_value = np.mean(
self.oscillator_history[-self.smoothing_period :]
+ [oscillator_value]
)
...
"current_signal": self.oscillator_history[-1]
