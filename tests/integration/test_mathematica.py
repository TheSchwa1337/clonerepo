...
from sympy.core import Derivative, Eq, Function, Ge, Gt, Integer, Le, Lt, Ne, Rational, S, Tuple, oo, pi, symbols
...
def test_matrices():
    from sympy.matrices import ImmutableDenseMatrix, ImmutableSparseMatrix, MutableDenseMatrix, MutableSparseMatrix
