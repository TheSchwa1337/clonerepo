...
from numba.cuda import compile, compile_for_current_device, compile_ptx, compile_ptx_for_current_device
...
class TestCompile(unittest.TestCase):
    ...
    def test_c_abi_device_function(self):
        ...
        # should be 32 bits
        self.assertRegex(ptx, r"\.visible\s+\.func\s+\(\.param\s+\.b32\s+" r"func_retval0\)\s+f\(")
    ...
    def test_c_abi_device_function_module_scope(self):
        ...
        self.assertRegex(ptx, r"\.visible\s+\.func\s+\(\.param\s+\.b32\s+" r"func_retval0\)\s+f_module\(")
    ...
    def test_compile_to_ltoir(self):
        ...
        ltoir, resty = compile(f_module, int32(int32, int32), device=True, output="ltoir")
