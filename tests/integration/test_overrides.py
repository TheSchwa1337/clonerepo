...
import numpy as np
import pytest
from numpy._core.overrides import _get_implementing_args, array_function_dispatch, verify_matching_signatures
...
class TestArrayLike:
    ...
    _array_tests = [
        ...
        (
            'genfromtxt',
            *func_args(lambda: StringIO('1,2.1'), dtype=[('int', 'i8'), ('float', 'f8')], delimiter=','),
        ),
    ]
