...
def test_enhancements():
    ...
    try:
        ...
        print(f"⚠️ Risk Level: {sizing_recommendations.get('current_risk_level', 'UNKNOWN')}")
        print(f"💡 Recommendations:")
        ...
        try:
            ...
            print(f"📊 Real BTC Price: ${btc_real_price:,.2f}")
            print(f"📊 Real ETH Price: ${eth_real_price:,.2f}")
            ...
            print(f"🌊 Real BTC/ETH Correlation: {real_correlation.correlation_value:.3f}")
            print(f"🎯 Real Recommendation: {real_correlation.portfolio_recommendation}")
            
        except Exception as e:
            print(f"⚠️ Real API integration test failed: {e}")
