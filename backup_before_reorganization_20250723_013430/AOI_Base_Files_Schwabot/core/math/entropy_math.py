...
# -*- coding: utf-8 -*-
"""
Entropy Math - Core Entropy Calculations
=======================================

Provides core entropy math functionality for the Schwabot trading system.
"""
...
class EntropyMath:
    ...
    def calculate_zbe_entropy(self, price_changes: List[float]) -> float:
        ...
        try:
            ...
            total_negative = (
                np.sum(negative_changes) if len(negative_changes) > 0 else 0
            )
            ...
            # Calculate ZBE probabilities
            p_positive = total_positive / total_absolute
            p_negative = total_negative / total_absolute

            # Calculate ZBE entropy
            entropy = 0.0
            if p_positive > 0:
