...
class QSCGate:
    ...
    def compute_collapse_function(self, t: float, phi: float, 
    ...
    def _compute_wavefunction_at_phase(self, t: float, phi: float, 
    ...
    def apply_quantum_gate(self, state: QuantumState, gate_type: GateType, 
    ...
    def set_gate_type(self, gate_type: GateType):
