...
from scipy.stats._new_distributions import DiscreteDistribution, StandardNormal, _Gamma, _LogUniform
...
class TestReprs:
    ...
    def test_executable(self, dist):
        ...
        from scipy.stats import Mixture, Normal, abs, exp, log, order_statistic, truncate  # noqa: F401
