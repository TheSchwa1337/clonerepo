...
from sympy.functions import Piecewise, ceiling, cos, exp, sin, sinc, sqrt
...
from sympy.matrices import HadamardProduct, Identity, Matrix, MatrixSymbol, SparseMatrix, eye
