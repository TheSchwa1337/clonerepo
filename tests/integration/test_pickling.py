...
from sympy.core.numbers import AlgebraicNumber, E, Float, I, Integer, Rational, nan, oo, pi, zoo
...
def test_pickling_polys_orderings():
    from sympy.polys.orderings import GradedLexOrder, InverseOrder, LexOrder, ReversedGradedLexOrder
