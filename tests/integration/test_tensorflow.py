...
from sympy.codegen.cfunctions import isinf, isnan
...
from sympy.tensor.array.expressions.array_expressions import ArrayAdd, ArrayDiagonal, ArrayTensorProduct, PermuteDims
