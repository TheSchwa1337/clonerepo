...
from sympy.physics.units.util import check_dimensions, convert_to
...
def test_eval_simplify():
    from sympy.core.symbol import symbols
    from sympy.physics.units import K, cm, kilo, km, m, mm
...
def test_quantity_simplify():
    from sympy.core.symbol import symbols
    from sympy.physics.units import foot, kilo
