...
from matplotlib.patches import Annulus, Arc, BoxStyle, Ellipse, FancyArrow, FancyArrowPatch, Patch, Polygon, Rectangle
...
def test_color_override_warning(kwarg):
    with pytest.warns(
        UserWarning,
        match="Setting the 'color' property will override " "the edgecolor or facecolor properties.",
    ):
